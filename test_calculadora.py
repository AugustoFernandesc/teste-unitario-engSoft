...
class TestCalculadora(unittest.TestCase):
    ...
    def test_calcular_media_com_inteiros(self):
        """Testa a média de uma lista com números inteiros."""
        self.assertEqual(calcular_media([10, 8, 6]), 8)

    def test_calcular_media_com_decimais(self):
        """Testa a média de uma lista com números decimais."""
        self.assertEqual(calcular_media([7.5, 8.5, 9.0]), 8.333333333333334)

    def test_calcular_media_com_um_numero(self):
        """Testa a média de uma lista com apenas um número."""
